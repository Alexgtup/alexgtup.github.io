...
AI={
 'ai-chatbot-development':{
   ...
   'task_intro':'Отдельный интент этой страницы — пользовательский AI-чат: консультация, поиск по базе знаний, сбор данных, работа с API и передача диалога человеку. Автоматизация внутренних бизнес-процессов вынесена в отдельное направление.',
 },
 'ai-automation':{
...
for needle in ['AI-чат-ботов и ассистентов','Telegram, сайт и база знаний','пользовательский AI-чат']:
