...
PROJECTS = [
    ...
    dict(slug='marketplace-monitor', title='Маркетплейсы: мониторинг', meta='OZON · WB · YANDEX MARKET', desc='Ежедневный сбор цен, скидок, остатков и статусов по нескольким маркетплейсам с историей в Google Sheets.', cats='marketplace automation web', tags=['Ozon','Wildberries','Google Sheets'], accent='#c9ff4a', kind='image', image='/assets/cases/marketplace-monitor/marketplace-monitor-01.webp', width=1448, height=1086, badge='Marketplaces'),
    dict(slug='ozon-scanner', title='Ozon: склад и сканер', meta='OZON · BARCODE · EXCEL', desc='Сканер штрихкодов запускает цепочку учёта: упаковка, паллеты, операции, остатки, резерв и подготовка отгрузки.', cats='marketplace automation web', tags=['Ozon','Barcode','Excel'], accent='#85e7dc', kind='image', image='/assets/cases/ozon-scanner/ozon-scanner-01.webp', width=1448, height=1086, badge='Warehouse'),
    dict(slug='wordpress-commercial', title='Коммерческий WordPress', meta='WORDPRESS · PHP · JS', desc='Развитие действующего WordPress-сайта: страницы, формы, калькуляторы, адаптив и UI без переписывания темы.', cats='wordpress web', tags=['WordPress','PHP','Forms'], accent='#8195ff', kind='image', image='/assets/cases/wordpress-commercial/wordpress-commercial-01.webp', width=1045, height=950, badge='WordPress'),
    dict(slug='portfolio-site', title='Сайт-портфолио Alexuys', meta='WEB · SEO · PORTFOLIO', desc='Многостраничный сайт-портфолио: услуги, кейсы, адаптив, schema, sitemap и внутренняя перелинковка.', cats='web seo', tags=['Web','SEO','Portfolio'], accent='#9d7fff', kind='image', image='/assets/cases/portfolio-site/portfolio-site-01.webp', width=1600, height=1200, badge='Portfolio'),
...
HOME_SLUGS = ['marketplace-monitor','ozon-scanner','wordpress-commercial','freelance-os','siteaudit-studio','seo-control-center','sheetpilot-ai','fin-planner','swift-calendar','auto-crm','factory-catalog','taxi-app']
FILTERS = [('all','Все'),('marketplace','Маркетплейсы'),('wordpress','WordPress'),('crm','CRM'),('seo','SEO'),('ai','AI'),('telegram','Telegram'),('automation','Automation'),('mobile','Mobile'),('web','Web')]
