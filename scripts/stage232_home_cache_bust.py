...
s,n=re.subn(r'<body\b([^>]*)>',lambda m:'<body'+m.group(1)+' data-stage232-build="svg-world-231">',s,count=1,flags=re.I)
...
s=s.replace('/assets/stage231-hero-installation.svg"','/assets/stage231-hero-installation.svg?v=55e1a53"')
p.write_text(s,encoding='utf8')
f=p.read_text(encoding='utf8')
for needle in ['data-stage232-build="svg-world-231"','data-stage232-cache="true"','stage231-hero-installation.svg?v=55e1a53']:
