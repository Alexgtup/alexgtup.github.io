...
s,n=re.subn(r'<body\b([^>]*)>',lambda m:'<body'+m.group(1)+' data-stage232-build="cinematic-235">',s,count=1,flags=re.I)
...
s=s.replace('/assets/stage235-crystal-system.svg"','/assets/stage235-crystal-system.svg?v=235"')
p.write_text(s,encoding='utf8')
f=p.read_text(encoding='utf8')
for needle in ['data-stage232-build="cinematic-235"','data-stage232-cache="true"','stage235-crystal-system.svg?v=235']:
