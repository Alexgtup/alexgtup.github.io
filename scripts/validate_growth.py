...
# artifact, not an intermediate template, gets the same UX baseline, pruning, type scale,
# content-aware layout geometry, final visual system and user-facing language polish.
