...
.s177-kicker{display:block;margin:0 0 12px;color:#596158;font:700 10px/1.35 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.14em;text-transform:uppercase}
...
.s177-review-meta{margin-top:10px!important;color:#5d655c!important;font-size:11px!important}
...
PAGES = {
    ...
    "telegram-bot-repair": {
        ...
        "author": "Артём · Telegram-бот · 02.10.2025",
        "proof_href": "/cases/fin-planner/",
        "proof_kicker": "RELATED TELEGRAM WORK",
        "proof_title": "Fin Planner",
        "proof_text": "Реальный Telegram-проект с состояниями, данными и backend-логикой.",
        "step": "Пришлите репозиторий или архив и коротко опишите ошибку или новую функцию.",
        "cta": "Показать код и задачу ↗",
    },
    "web-development": {
