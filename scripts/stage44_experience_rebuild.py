...
<section class="s44-section s44-brief-section" aria-labelledby="brief-title" id="brief">
  <div class="container">
    <div class="s44-section-head"><span class="s44-index" data-nosnippet="">06 / СТАРТ</span><div><h2 id="brief-title">Расскажите, <em>что нужно разработать.</em></h2><p>Достаточно описать задачу. Остальные поля можно пропустить. Подготовленный текст отправьте в Telegram или по почте — как вам удобнее.</p></div></div>
    <noscript><style>#s44-brief-form{display:none}</style><p>Напишите задачу в <a href="https://t.me/Alexuys" aria-label="Telegram @Alexuys">Telegram @Alexuys</a> или на <a href="mailto:alexgtup@gmail.com" aria-label="Почта alexgtup@gmail.com">alexgtup@gmail.com</a>.</p></noscript>
    <form class="s44-brief" id="s44-brief-form">
      ...
      <label class="s44-brief__wide"><span>Задача своими словами</span><textarea name="task" required maxlength="3000" rows="5" placeholder="Что должно работать в итоге?"></textarea></label>
      <label><span>Что уже есть</span><input name="current" type="text" maxlength="500" placeholder="Сайт, код, Figma, ТЗ или только идея"/></label>
      <label><span>Срок / бюджет, если есть</span><input name="limits" type="text" maxlength="200" placeholder="Например: до 2 недель / ориентир 30–50 тыс."/></label>
      <div class="s44-brief__footer"><p>После перехода нажмите «Отправить» в Telegram. До этого сообщение остаётся черновиком.</p><button class="button primary" type="submit" disabled>Открыть Telegram с текстом ↗</button><button class="button" type="button" data-brief-preview disabled>Почта или копирование</button></div>
      <p class="s44-brief__wide" data-brief-status role="status" aria-live="polite"></p>
      <div class="s44-brief__wide" data-brief-result hidden>
        <label><span>Ваше сообщение</span><textarea data-brief-draft aria-label="Ваше сообщение" readonly rows="7"></textarea></label>
        <div class="s44-actions"><a class="button primary" data-brief-email href="mailto:alexgtup@gmail.com">Открыть письмо ↗</a><button class="button" type="button" data-brief-copy>Скопировать текст</button><a class="button" data-brief-telegram href="https://t.me/Alexuys" target="_blank" rel="noopener noreferrer">Открыть Telegram ещё раз ↗</a></div>
        <p>Если приложение не открылось, скопируйте текст и отправьте на <a href="mailto:alexgtup@gmail.com">alexgtup@gmail.com</a> или в Telegram <a href="https://t.me/Alexuys" target="_blank" rel="noopener noreferrer">@Alexuys</a>.</p>
      </div>
    </form>
  </div>
</section>
