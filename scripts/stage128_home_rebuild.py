...
<section class="p128-hero" aria-labelledby="p128-title">
  <div class="p128-shell">
    ...
    <div class="p128-proofbar" aria-label="Проверяемые факты">
      <a href="https://freelance.ru/gglalex" target="_blank" rel="me noopener noreferrer"><strong>18</strong><span>публичных отзывов</span></a>
...
<section class="p128-proof" id="reviews" aria-labelledby="p128-proof-title">
  <div class="p128-shell p128-proof__grid">
    ...
    <div class="p128-proof__numbers"><div><strong>18</strong><span>отзывов в открытом профиле</span></div><div><strong>10/10</strong><span>профессионализм</span></div><div><strong>9/10</strong><span>коммуникация</span></div><div><strong>6 лет</strong><span>опыта в публичном профиле</span></div></div>
  </div>
</section>
