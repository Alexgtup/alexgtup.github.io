...
В публичной выдаче Freelance.ru профиль Alexandr Alexandr / gglalex отображается с 20 отзывами и оценками 9/9. В откликах этого профиля также используется Telegram @Alexuys, что связывает внешний профиль с портфолио.
